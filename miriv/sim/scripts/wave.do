...
add wave -noupdate -group fetch /tb_cpu/dut/pipeline_inst/fetch_inst/clk
add wave -noupdate -group fetch /tb_cpu/dut/pipeline_inst/fetch_inst/res_n
...
add wave -noupdate -group fetch /tb_cpu/dut/pipeline_inst/fetch_inst/pc_in
add wave -noupdate -group fetch /tb_cpu/dut/pipeline_inst/fetch_inst/pc_out
add wave -noupdate -group fetch /tb_cpu/dut/pipeline_inst/fetch_inst/instr
add wave -noupdate -group fetch /tb_cpu/dut/pipeline_inst/fetch_inst/mem_out
add wave -noupdate -group fetch /tb_cpu/dut/pipeline_inst/fetch_inst/mem_in
add wave -noupdate -group fetch /tb_cpu/dut/pipeline_inst/fetch_inst/pc_counter_reg
add wave -noupdate -group fetch /tb_cpu/dut/pipeline_inst/fetch_inst/pc_counter_reg_next
add wave -noupdate -group fetch /tb_cpu/dut/pipeline_inst/fetch_inst/pcsrc_reg
add wave -noupdate -group fetch /tb_cpu/dut/pipeline_inst/fetch_inst/pcsrc_reg_next
add wave -noupdate -group fetch /tb_cpu/dut/pipeline_inst/fetch_inst/pc_in_reg
add wave -noupdate -group fetch /tb_cpu/dut/pipeline_inst/fetch_inst/pc_in_reg_next
add wave -noupdate -group fetch /tb_cpu/dut/pipeline_inst/fetch_inst/mem_in_reg
add wave -noupdate -group fetch /tb_cpu/dut/pipeline_inst/fetch_inst/mem_in_reg_next
add wave -noupdate -divider -height 40 decode
add wave -noupdate -group decode /tb_cpu/dut/pipeline_inst/decode_inst/clk
add wave -noupdate -group decode /tb_cpu/dut/pipeline_inst/decode_inst/res_n
...
add wave -noupdate -group decode /tb_cpu/dut/pipeline_inst/decode_inst/pc_in
add wave -noupdate -group decode /tb_cpu/dut/pipeline_inst/decode_inst/instr
add wave -noupdate -group decode /tb_cpu/dut/pipeline_inst/decode_inst/reg_write
add wave -noupdate -group decode /tb_cpu/dut/pipeline_inst/decode_inst/pc_out
add wave -noupdate -group decode /tb_cpu/dut/pipeline_inst/decode_inst/exec_op
...
add wave -noupdate -group decode /tb_cpu/dut/pipeline_inst/decode_inst/instr_reg
add wave -noupdate -group decode /tb_cpu/dut/pipeline_inst/decode_inst/pc_in_reg
add wave -noupdate -group decode /tb_cpu/dut/pipeline_inst/decode_inst/regfile_rdaddr1
add wave -noupdate -group decode /tb_cpu/dut/pipeline_inst/decode_inst/regfile_rdaddr2
add wave -noupdate -group decode /tb_cpu/dut/pipeline_inst/decode_inst/regfile_rddata1
add wave -noupdate -group decode /tb_cpu/dut/pipeline_inst/decode_inst/regfile_rddata2
add wave -noupdate -group decode /tb_cpu/dut/pipeline_inst/decode_inst/regfile_wraddr
add wave -noupdate -group decode /tb_cpu/dut/pipeline_inst/decode_inst/regfile_wrdata
add wave -noupdate -group decode /tb_cpu/dut/pipeline_inst/decode_inst/regfile_write
add wave -noupdate -divider -height 40 exec
add wave -noupdate -group exec /tb_cpu/dut/pipeline_inst/exec_inst/clk
add wave -noupdate -group exec /tb_cpu/dut/pipeline_inst/exec_inst/res_n
...
add wave -noupdate -group exec /tb_cpu/dut/pipeline_inst/exec_inst/op
add wave -noupdate -group exec /tb_cpu/dut/pipeline_inst/exec_inst/pc_in
add wave -noupdate -group exec /tb_cpu/dut/pipeline_inst/exec_inst/pc_old_out
add wave -noupdate -group exec /tb_cpu/dut/pipeline_inst/exec_inst/pc_new_out
add wave -noupdate -group exec /tb_cpu/dut/pipeline_inst/exec_inst/aluresult
add wave -noupdate -group exec /tb_cpu/dut/pipeline_inst/exec_inst/wrdata
add wave -noupdate -group exec /tb_cpu/dut/pipeline_inst/exec_inst/zero
add wave -noupdate -group exec /tb_cpu/dut/pipeline_inst/exec_inst/memop_in
add wave -noupdate -group exec /tb_cpu/dut/pipeline_inst/exec_inst/memop_out
add wave -noupdate -group exec /tb_cpu/dut/pipeline_inst/exec_inst/wbop_in
add wave -noupdate -group exec /tb_cpu/dut/pipeline_inst/exec_inst/wbop_out
add wave -noupdate -group exec /tb_cpu/dut/pipeline_inst/exec_inst/exec_op
add wave -noupdate -group exec /tb_cpu/dut/pipeline_inst/exec_inst/reg_write_mem
add wave -noupdate -group exec /tb_cpu/dut/pipeline_inst/exec_inst/reg_write_wr
add wave -noupdate -group exec /tb_cpu/dut/pipeline_inst/exec_inst/wbop_reg
add wave -noupdate -group exec /tb_cpu/dut/pipeline_inst/exec_inst/wbop_reg_next
add wave -noupdate -group exec /tb_cpu/dut/pipeline_inst/exec_inst/mem_op_reg
add wave -noupdate -group exec /tb_cpu/dut/pipeline_inst/exec_inst/mem_op_reg_next
add wave -noupdate -group exec /tb_cpu/dut/pipeline_inst/exec_inst/pc_old_reg
add wave -noupdate -group exec /tb_cpu/dut/pipeline_inst/exec_inst/pc_old_reg_next
add wave -noupdate -group exec /tb_cpu/dut/pipeline_inst/exec_inst/temp_pc_new_out
add wave -noupdate -group exec /tb_cpu/dut/pipeline_inst/exec_inst/exec_op_reg
add wave -noupdate -group exec /tb_cpu/dut/pipeline_inst/exec_inst/exec_op_reg_next
add wave -noupdate -group exec /tb_cpu/dut/pipeline_inst/exec_inst/pc_add_A_reg
add wave -noupdate -group exec /tb_cpu/dut/pipeline_inst/exec_inst/pc_add_A_reg_next
add wave -noupdate -group exec /tb_cpu/dut/pipeline_inst/exec_inst/pc_add_B_reg
add wave -noupdate -group exec /tb_cpu/dut/pipeline_inst/exec_inst/pc_add_B_reg_next
